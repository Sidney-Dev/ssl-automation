...
<body>
    ...
    <div class="min-h-screen bg-gray-100">
            ...
            <div class="max-w-7xl mx-auto">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="bg-white border-b border-gray-200 py-8 sm:px-20 items-center">
                        ...
                        <div class="flex items-center">
                            <label>domain</label>
                            <div class="block w-3/4 p-2.5 mx-auto">
                                <input type="url" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full">
        ...
        <div class="flex justify-end max-w-7xl mx-auto">
            ...
            <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2" onclick="toggleSuccessToast()">Create Certificate</a>
        </div>
