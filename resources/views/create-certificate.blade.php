    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <form method="post" action="{{ url('/create-certificate') }}">
            ...
            <div class="flex justify-end max-w-7xl mx-auto sm:px-6">
                ...
                <input type="submit" name="create" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2" value="Create Certificate"/>
            </div>
        </form>
    </div>
